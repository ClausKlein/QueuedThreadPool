...
namespace chrono
{
    ...
    public:
        ...
        explicit suspendable_stopwatch(const dont_start_t&)
            : start_(duration::zero())
            , running_(false)
            , suspended_(false)
            , laps_collector_()
        ...
        explicit suspendable_stopwatch(laps_collector const& acc)
            : start_(duration::zero())
            , running_(false)
            , suspended_(false)
            , laps_collector_(acc)
        ...
        laps_collector const& get_laps_collector() { return laps_collector_; }
        ...
        typedef stopwatch_suspender<
            suspendable_stopwatch<Clock, LapsCollector> >
            scoped_suspend;
