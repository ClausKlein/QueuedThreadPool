...
namespace chrono
{
    ...
    template <class CharT, class Stopwatch,
        class Formatter =
            basic_stopwatch_reporter_default_formatter<CharT, Stopwatch> >
    ...
    public:
        ...
        basic_stopwatch_reporter() BOOST_NOEXCEPT : formatter_(),
                                                    reported_(false)
        { }
        ...
        explicit basic_stopwatch_reporter(
            const dont_start_t& tag) BOOST_NOEXCEPT : base_type(tag),
                                                      formatter_(),
                                                      reported_(false)
        { }

        explicit basic_stopwatch_reporter(
            const typename Formatter::char_type* fmt)
            : formatter_(fmt)
            , reported_(false)
        { }
        explicit basic_stopwatch_reporter(
            typename Formatter::string_type const& fmt)
            : formatter_(fmt)
            , reported_(false)
        { }
        ...
        formatter_type& format() { return formatter_; }
    ...
    protected:
        ...
        basic_stopwatch_reporter& operator=(
            const basic_stopwatch_reporter&); // = delete;
    };

    template <class Stopwatch,
        class Formatter = typename basic_stopwatch_reporter_default_formatter<
            char, Stopwatch>::type>
    class stopwatch_reporter;

    template <class Stopwatch, class Formatter>
    struct basic_stopwatch_reporter_default_formatter<char,
        stopwatch_reporter<Stopwatch, Formatter> > {
        typedef Formatter type;
    };

    template <class Stopwatch, class Formatter>
    class stopwatch_reporter
        : public basic_stopwatch_reporter<char, Stopwatch, Formatter> {
    ...
    public:
        ...
        { }
#endif
        explicit stopwatch_reporter(const dont_start_t& tag) BOOST_NOEXCEPT
            : base_type(tag)
        { }
    ...
    template <class Stopwatch,
        class Formatter = typename basic_stopwatch_reporter_default_formatter<
            wchar_t, Stopwatch>::type>
    class wstopwatch_reporter;

    template <class Stopwatch, class Formatter>
    struct basic_stopwatch_reporter_default_formatter<wchar_t,
        wstopwatch_reporter<Stopwatch, Formatter> > {
        typedef Formatter type;
    };

    template <class Stopwatch, class Formatter>
    class wstopwatch_reporter
        : public basic_stopwatch_reporter<wchar_t, Stopwatch, Formatter> {
        typedef basic_stopwatch_reporter<wchar_t, Stopwatch, Formatter>
            base_type;
    ...
    public:
        ...
        { }
#endif
        explicit wstopwatch_reporter(const dont_start_t& tag) BOOST_NOEXCEPT
            : base_type(tag)
        { }
    ...
    protected:
        ...
        wstopwatch_reporter& operator=(
            const wstopwatch_reporter&); // = delete;
    };
